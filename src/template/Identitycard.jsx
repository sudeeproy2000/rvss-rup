          ...
          <div className="col-6" id="template1">
            ...
            >
              ...
              >
                ...
                >
                  {obj.formData.studentfname +
                    " " +
                    obj.formData.studentmname +
                    " " +
                    obj.formData.studentlname}
                </div>
                <div
                  style={{
                    backgroundColor: "#e94560",
                ...
                >
                  <div style={{ width: "50%" }}>
                    ...
                    >
                      <li>
                        Father name:
                        {obj.formData.guardianfname +
                          " " +
                          obj.formData.guardianlname}
                      </li>
                  ...
                  >
                    <img
                      src={schoolData.schoolFiles.image1_location}
                      style={{
                        width: "70px",
                        height: "70px",
                        marginLeft: "60%",
